                ...
                <div class="card">
                    <div class="card-body">
                            <div class="form-group">
                                ...
                                {!! Form::text('name', old('name', $news->name), array('id'=>'name','placeholder' => 'Name','class' => 'form-control','required' => 'required')) !!}
                            </div>
                            <div class="form-group">
                                <label for="roles">Category</label>
                                {!! Form::select('cat_id', $category, old('cat_id',$news->cat_id) , array('class' => 'form-control select2', 'placeholder' => '','required' => 'required')) !!}
                            </div>
                            <div class="form-group">
